  ...
  return (
    <div className="realtime-container">
      ...
      <div className="status-wrapper">
        ...
        <button onClick={handleReconnect} className="reconnect-button" disabled={isConnecting}>
      ...
      <div className="sensor-section">
        ...
        <button onClick={() => setShowTable1(!showTable1)} className="toggle-button">
      ...
      <div className="sensor-section">
        ...
        <button onClick={() => setShowTable2(!showTable2)} className="toggle-button">
